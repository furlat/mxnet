...
if nstream == 1:
    ...
    if bilinear:
        arch+='_bilinear'
    sym,data,labels=net.get_symbol(num_classes=num_classes,active=[1],bilinear=bilinear, gate_prefix=None,rescale_grad=1, num_layers=50,gated=False, image_shape=image_shape)
elif nstream==2:
