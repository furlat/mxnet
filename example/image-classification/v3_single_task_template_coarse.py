...
def inat_global_iterator(data_dir,batch_size):
    train = mx.io.ImageRecordIter(
            path_imglist=os.path.join(data_dir, "inat_train.lst"),
            path_imgrec         = os.path.join(data_dir, "inat_train.rec"),
            label_width         = 2,
            data_name           = 'data',
    ...
    val = mx.io.ImageRecordIter(
            path_imgrec         = os.path.join(data_dir, "inat_val.rec"),
            path_imglist=os.path.join(data_dir, "inat_val.lst"),
            label_width         = 2,
            data_name           = 'data',
            label_name          = 'softmax1_label',
            batch_size          = batch_size,
...
train_inat, val_inat = inat_global_iterator(data_dir,batch_size)

train_inat=inat_sub_iterator(train_inat,[1])
