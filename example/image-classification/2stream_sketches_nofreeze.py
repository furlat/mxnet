...
sym,data,labels=net.get_symbol_2branch(num_classes=365,active=1,gate_prefix=None,rescale_grad=1, num_layers=50,gated=True, image_shape=image_shape,coupled=True)
...
model_prefix = '/home/ubuntu/results/resnet-2streams-gated-humansketch-coupled-freeze' 
checkpoint = mx.callback.module_checkpoint(mod,model_prefix)
