...
def _download(data_dir):
    ...
    os.chdir(data_dir)
    if (not os.path.exists('train-images-idx3-ubyte')) or        (not os.path.exists('train-labels-idx1-ubyte')) or        (not os.path.exists('t10k-images-idx3-ubyte')) or        (not os.path.exists('t10k-labels-idx1-ubyte')):
...
def get_symbol():
    ...
    gated_fc4=mx.sym.broadcast_mul(fc4,gate)
    act4 = mx.symbol.Activation(data=gated_fc4, name='relu4', act_type='relu')
