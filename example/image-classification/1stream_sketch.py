...
ctx=[mx.gpu(12),mx.gpu(13),mx.gpu(14),mx.gpu(15)]
...
sym,data,labels=net.get_symbol(num_classes=365,active=1,gate_prefix=None,rescale_grad=1, num_layers=50,gated=True, image_shape=image_shape)
...
# In[ ]:
model_prefix = '/efs/datasets/users/furlat/results/human_sketches/resnet-1streams-rand-humansketch-' 
#epoch=21
