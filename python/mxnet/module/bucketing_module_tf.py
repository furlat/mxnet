...
class BucketingModule(BaseModule):
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        self._curr_module = module # Probably comment here
    ...
    def switch_bucket(self, bucket_key, data_shapes, label_shapes=None):
        ...
        if not bucket_key in self._buckets:
            ...
            module.keys_dict=self._buckets[self._default_bucket_key].keys_dict
            self._buckets[bucket_key] = module
            #seelf.setopt_bucket(local_state[bucket],shared_state,kvstore) #I wROTE IT
    ...
    def init_optimizer(self, kvstore='local', optimizer='sgd',
        ...
        for mod in self._buckets.values():
            #print self._buckets.values()
            if mod is not self._curr_module:
                #print 'getting borrowed'
